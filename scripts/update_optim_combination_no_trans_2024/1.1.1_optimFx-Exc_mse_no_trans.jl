...
savepath = datadir("results","optim_comb_no_trans_2024","Fx-Exc","mse","B00") 
mkpath(savepath) 
...
savepath = datadir("results","optim_comb_no_trans_2024","Fx-Exc","mse","B10") 
mkpath(savepath)
## Lote de simulación con los primeros 100 vectores de exclusión
...
#[28  42  47  64  65  6  46  63  58  41  32]
...
savepath00 = datadir("results","optim_comb_no_trans_2024","B00","mse") 
savepath10 = datadir("results","optim_comb_no_trans_2024","B10","mse")
