...
savepath = datadir("results","optim_comb_2024_B","Fx-Exc","corr","B00")  
...
sort_0019 = sort(Exc_0019, :gt_b08_corr, rev=true)
...
savepath = datadir("results","optim_comb_2024_B","Fx-Exc","corr","B10") 
...
## Definimos la correlación promedio entre bases
Exc_1018.gt_b0820_corr = 0.5 .* Exc_1018.gt_b08_corr .+ 0.5 .* Exc_1018.gt_b20_corr
...
# DF ordenado por corr promedio
sort_1019 = sort(Exc_1018, :gt_b0820_corr, rev=true)

## Exctracción de vector de exclusión  y corr
Exc = collect(sort_1019[1,:params])

# [35, 30, 190, 36, 37, 40, 31, 104, 162, 32, 33, 159, 193, 161]
# [29, 46, 39, 31, 116, 40, 30, 186, 35, 47  …  113, 236, 117, 148, 49, 268, 213, 20, 9, 202]

## Guardando resultado optimo con las demas medidas

savepath = datadir("results","optim_comb_2024_B","corr") 
