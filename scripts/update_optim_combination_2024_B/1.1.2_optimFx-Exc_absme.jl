...
savepath = datadir("results","optim_comb_2024_B","Fx-Exc","absme","B00")  
...
# DF ordenado por ABSME
sort_0019 = sort(Exc_0019, :gt_b08_absme)

## Exctracción de vector de exclusión  y ABSME
...
savepath = datadir("results","optim_comb_2024_B","Fx-Exc","absme","B10") 
...
# DF ordenado por ABSME
sort_1019 = sort(Exc_1018, :gt_b20_absme)

## Exctracción de vector de exclusión  y ABSME
Exc = collect(sort_1019[1,:params])

# [35, 30, 190, 36, 37, 40, 31]
# [29, 46, 39, 31, 116, 40]

# guardamos el mejor resultado
savepath = datadir("results","optim_comb_2024_B","absme") 
