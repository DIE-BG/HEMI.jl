...
p1 = plot(bp, optmse2022, data, 
    label = "Restricted combination of core measures", 
    linewidth = 3,
    palette = :darkrainbow,
) 
...
savefig(joinpath(plots_savepath, "restricted_mse_core_measures.pdf"))