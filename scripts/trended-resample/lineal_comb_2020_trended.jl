...
data_savepath = datadir("results", "mse-combination", "naive-2020-trended", "data")
plots_path = mkpath(plotsdir("mse-combination", "naive-2020-trended"))
...
resamplefn = ResampleScrambleTrended(0.505025)
...
rest_optmse_weights = share_combination_weights(comb_tray_infl, tray_infl_param, show_status=true)
wsave(joinpath(data_savepath, "rest_optmse_weights.jld2"), "rest_optmse_weights", rest_optmse_weights)
