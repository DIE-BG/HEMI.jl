...
combination_loadpath  = datadir("results","optim_combination","mse_noMAI_rescale")

save_results = datadir("results","eval","mse_noMAI_rescale")
...
# ├───────────────────────────────────────────────┼────────────┼──────────┼───────────┼───────────┼──────────┼──────────────┤
# │                 Percentil equiponderado 71.96 │   0.267312 │ 0.201842 │  0.119261 │ 0.0563398 │ 0.244139 │      0.12502 │
# │                     Percentil ponderado 69.86 │   0.228327 │ 0.424832 │  0.253189 │  0.205343 │ 0.409463 │     0.306798 │
# │     Media Truncada Equiponderada (57.0, 84.0) │   0.486143 │ 0.173026 │ 0.0756666 │ 0.0691272 │ 0.218107 │     0.116417 │
# │       Media Truncada Ponderada (20.51, 95.98) │ 1.13556e-6 │ 0.344158 │  0.206836 │  0.104031 │ 0.293714 │     0.217329 │
# │  Inflación de exclusión dinámica (0.34, 1.81) │  0.0182175 │ 0.327145 │  0.162758 │ 0.0867412 │ 0.291087 │     0.198941 │
# │ Exclusión fija de gastos básicos IPC (14, 17) │        0.0 │ 0.831064 │  0.895471 │  0.448037 │ 0.642199 │     0.641695 │
# │                    Subyacente óptima MSE 2023 │          1 │ 0.188282 │ 0.0921335 │ 0.0436153 │ 0.214693 │      0.11126 │
# │                 MAI (FP,4,[0.28, 0.72, 0.76]) │          0 │ 0.216984 │ 0.0836499 │ 0.0596975 │ 0.209307 │     0.131929 │
# │                  MAI (F,4,[0.38, 0.67, 0.83]) │          0 │ 0.256505 │  0.126606 │ 0.0953241 │ 0.327162 │     0.169651 │
# │            MAI (G,5,[0.06, 0.27, 0.74, 0.77]) │          0 │ 0.627207 │  0.366966 │  0.230421 │ 0.525295 │     0.416113 │
# └───────────────────────────────────────────────┴────────────┴──────────┴───────────┴───────────┴──────────┴──────────────┘
