...
save_results = datadir("results","eval","corr_noMAI_rescale")
...
# │                   Subyacente óptima CORR 2023 │          1 │ 0.977062 │  0.98722 │ 0.910357 │ 0.986722 │      0.992853 │
# │                 MAI (FP,4,[0.26, 0.51, 0.75]) │          0 │ 0.975304 │ 0.988008 │ 0.900723 │  0.98262 │      0.988608 │
# │                   MAI (F,4,[0.25, 0.5, 0.74]) │          0 │  0.97512 │ 0.987969 │ 0.899583 │ 0.982588 │      0.988616 │
# │                   MAI (G,4,[0.26, 0.5, 0.75]) │          0 │ 0.940058 │ 0.984834 │ 0.767826 │ 0.970803 │      0.977716 │
# └───────────────────────────────────────────────┴────────────┴──────────┴──────────┴──────────┴──────────┴───────────────┘
