...
savepath = datadir("optim_comb_2024","2000_2010","Fx-Exc","absme","B00")  
...
savepath = datadir("optim_comb_2024","2000_2010","Fx-Exc","absme","B10")   
...
savepath_mse_b00 = joinpath(savepath,"B00","absme")
savepath_mse_b10 = joinpath(savepath,"B10","absme")
