...
savepath = datadir("optim_comb_2024","2000_2010","Fx-Exc","corr","B00")  
...
savepath = datadir("optim_comb_2024","2000_2010","Fx-Exc","corr","B10")   
...
savepath_mse_b00 = joinpath(savepath,"B00","corr")
savepath_mse_b10 = joinpath(savepath,"B10","corr")
