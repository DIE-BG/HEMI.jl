...
grid_batch(gtdata,InflationTrimmedMeanEq, ResampleSBB(36),
            ...
            Date(2020,12);save_dir = save_dirs[1]
)
...
grid_batch(gtdata,InflationTrimmedMeanWeighted, ResampleSBB(36),
            ...
            Date(2020,12);save_dir = save_dirs[2]
)


## OPTIMIZACION ----------------------------------------------------------------------------
# definimos los directorios donde se encuentran los resultados de la grilla
dir_list = [joinpath("InflationTrimmedMeanEq","Esc-D","MTEq_SBB36_RW_Rebase60_N10000_2020-12"), 
            joinpath("InflationTrimmedMeanWeighted","Esc-D","MTW_SBB36_RW_Rebase60_N10000_2020-12")
]
...
cond = (df3[:,:paramfn].== InflationTotalRebaseCPI(60)) .& (df3[:,:traindate].== Date(2020,12))
...
Plots.svg(p, joinpath(plotpath, "trayectorias_MT20-60"))
