...
# Optimizar
# AMPLIAR EXPLICACIÓN DEL FLUJO DE TRABAJO ACÁ
dir_list = [joinpath("InflationTrimmedMeanEq","Esc-D","MTEq_SBB36_RW_Rebase36_N10000_2019-12"), 
            joinpath("InflationTrimmedMeanWeighted","Esc-D","MTW_SBB36_RW_Rebase36_N10000_2019-12")
]

grid_optim(dir_list[1],gtdata,125_000,7 ; esc="Esc-D")
grid_optim(dir_list[2],gtdata,125_000,7 ; esc="Esc-D")

# Obtenemos resultados optimos para 2019-36
...
cond = (df3[:,:paramfn].== InflationTotalRebaseCPI(36,2)) .& (df3[:,:traindate].== Date(2019,12))
...
Plots.svg(p, joinpath(plotpath, "trayectorias_MT19-36"))
