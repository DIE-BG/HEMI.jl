...
save_dirs = [joinpath("results","InflationTrimmedMeanEq","Esc-E"),
             joinpath("results","InflationTrimmedMeanWeighted","Esc-E")
]
...
grid_batch(gtdata,InflationTrimmedMeanEq, ResampleSBB(36),
            ...
            Date(2018,12);save_dir = save_dirs[1]
)
...
grid_batch(gtdata,InflationTrimmedMeanWeighted, ResampleSBB(36),
            ...
            Date(2018,12);save_dir = save_dirs[2]
)

## OPTIMIZACION ----------------------------------------------------------------------------
# definimos los directorios donde se encuentran los resultados de la grilla
dir_list = [joinpath(save_dirs[1],"MTEq_SBB36_RW_Rebase60_N10000_2018-12"), 
            joinpath(save_dirs[2],"MTW_SBB36_RW_Rebase60_N10000_2018-12")
]
...
plotpath = joinpath("docs", "src", "eval", "EscE", "images", "trimmed_mean")
