...
save_dirs = [joinpath("results","InflationTrimmedMeanEq","Esc-B"),
...
dir_list = [joinpath(save_dirs[1],"MTEq_SVM_RW_Rebase36_N10000_2020-12"), 
            joinpath(save_dirs[2],"MTW_SVM_RW_Rebase36_N10000_2020-12")
]
...
# cargamos los datos
df1 = collect_results(datadir(save_dirs[1]))
df2 = collect_results(datadir(save_dirs[2]))
df = vcat(df1,df2)
