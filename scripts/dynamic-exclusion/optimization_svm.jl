...
evalDynEx([2, 2], gtdata_eval, resamplefn = ResampleScrambleVarMonths())
...
initial_params = [0.42424244f0, 1.5151515f0]


f = factors_vec -> evalDynEx(
    factors_vec, gtdata_eval,
    resamplefn = resamplefn
)
...
save(
    datadir(savepath, "optres_dynEx_SVM.jld2"),
    Dict("optres" => optres)
)