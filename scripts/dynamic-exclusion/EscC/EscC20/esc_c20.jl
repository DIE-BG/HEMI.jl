# # Escenario C20: evaluación de criterios básicos con cambio de parámetro de evaluación
...
dict_config = Dict(
    :inflfn => InflationDynamicExclusion(0.37229058f0, 2.2744188f0),
...
Plots.svg(p, joinpath(PLOTSPATH, "obs_trajectory_c20"))
