...
savepath    = datadir("results", "no_trans", "tray_infl_test_TrimmedMean")
savepath_19 = datadir("results", "no_trans", "tray_infl_test_TrimmedMean", "tray_19")

inflfn_mse = [
    InflationTrimmedMeanEq(x,y) for x in [10:5:95...,99] for y in [x:5:95...,99]
]
...
loadpath    = datadir("results", "no_trans", "tray_infl_test_TrimmedMean")
loadpath_19 = datadir("results", "no_trans", "tray_infl_test_TrimmedMean", "tray_19")
...
for j in L
    ...
    plot1 = Gadfly.plot(
        ...
        Gadfly.Guide.title("TMEQ, MSE⁻¹, "*string(j)),
    ...
    img = SVG("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\TMEQ\\MSE_"*string(j)*".svg", 6inch, 4inch)
    ...
    for i in [1,2,3,4,5]
        ...
        display(p)
        savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\TMEQ\\MSE_"*string(j)*string(i)*".png")
    end
...
for j in L
    ...
    plot1 = Gadfly.plot(
        ...
        Gadfly.Guide.xlabel("ℓ₁"),
        Gadfly.Guide.ylabel("ℓ₂"),
        Gadfly.Guide.title("TMEQ, ABSME⁻¹, "*string(j)),
    ...
    img = SVG("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\TMEQ\\ABSME_"*string(j)*".svg", 6inch, 4inch)
    Gadfly.draw(img, plot1)
    display(plot1)
    ...
    for i in [1,2,3,4,5]
        ...
        display(p)
        savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\TMEQ\\ABSME_"*string(j)*string(i)*".png")
    end
...
for j in L
    ...
    img = SVG("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\TMEQ\\CORR_"*string(j)*".svg", 6inch, 4inch)
    Gadfly.draw(img, plot1)
    display(plot1)
    ...
    for i in [1,2,3,4,5]
        ...
        display(p)
        savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\TMEQ\\CORR_"*string(j)*string(i)*".png")
    end
