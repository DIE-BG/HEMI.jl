...
savepath = datadir("results","no_trans","optim","absme","Fx-Exc","B00")  
...
# Creación de vectores de exclusión
# Se crearán 60 vectores para la exploración inicial
global v_exc = []
global tot = []
global total = []
for i in 1:length(vec_v)
...
# Diccionarios para exploración inicial (primero 50 vectores de exclusión)
FxEx_10 = Dict(
    :inflfn => InflationFixedExclusionCPI.(total[1:50]), 
    :resamplefn => resamplefn, 
    :trendfn => trendfn,
    :paramfn => paramfn,
    :nsim => 10_000,
...
savepath = datadir("results","no_trans","optim","absme","Fx-Exc","B10")   
...
savepath00 = datadir("results","no_trans","optim","absme","B00") 
savepath10 = datadir("results","no_trans","optim","absme","B10")
