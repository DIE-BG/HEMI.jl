...
savepath    = datadir("results", "no_trans", "tray_infl_test_DE")
savepath_19 = datadir("results", "no_trans", "tray_infl_test_DE", "tray_19")

inflfn_mse = [
    InflationDynamicExclusion(x,y) for x in 0.25:0.25:4 for y in 0.25:0.25:4
]
...
loadpath    = datadir("results", "no_trans", "tray_infl_test_DE")
loadpath_19 = datadir("results", "no_trans", "tray_infl_test_DE", "tray_19")
...
for j in L
    ...
    plot1 = Gadfly.plot(
        ...
        Gadfly.Guide.title("DE, MSE⁻¹, "*string(j)),
    ...
    img = SVG("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\DE\\MSE_"*string(j)*".svg", 6inch, 4inch)
    ...
    for i in [1,2,3,4,5]
        ...
        display(p)
        savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\DE\\MSE_"*string(j)*string(i)*".png")
    end
...
for j in L
    ...
    img = SVG("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\DE\\ABSME_"*string(j)*".svg", 6inch, 4inch)
    Gadfly.draw(img, plot1)
    display(plot1)
    ...
    for i in [1,2,3,4,5]
        ...
        display(p)
        savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\DE\\ABSME_"*string(j)*string(i)*".png")
    end
...
for j in L
    ...
    img = SVG("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\DE\\CORR_"*string(j)*".svg", 6inch, 4inch)
    Gadfly.draw(img, plot1)
    display(plot1)
    ...
    for i in [1,2,3,4,5]
        ...
        display(p)
        savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\DE\\CORR_"*string(j)*string(i)*".png")
    end
