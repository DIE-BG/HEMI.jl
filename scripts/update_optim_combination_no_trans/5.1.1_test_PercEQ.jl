...
savepath    = datadir("results", "no_trans","tray_infl_test_perc")
savepath_19 = datadir("results", "no_trans","tray_infl_test_perc","tray_19")

inflfn_mse = [
    InflationPercentileEq(x) for x in 11:99
]
...
loadpath    = datadir("results", "no_trans","tray_infl_test_perc")
loadpath_19 = datadir("results", "no_trans","tray_infl_test_perc","tray_19")
...
for j in L
    ...
    savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\PercEQ\\MSE_"*string(j)*".png")
    ...
    for i in [1,2,3,4,5]
        ...
        display(p)
        savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\PercEQ\\MSE_"*string(j)*string(i)*".png")
    end
end
...
for j in L
    ...
    savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\PercEQ\\ABSME_"*string(j)*".png")
    ...
    for i in [1,2,3,4,5]
        ...
        display(p)
        savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\PercEQ\\ABSME_"*string(j)*string(i)*".png")
    end
end
...
for j in L
    ...
    savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\PercEQ\\CORR_"*string(j)*".png")
    ...
    for i in [1,2,3,4,5]
        ...
        display(p)
        savefig("C:\\Users\\DJGM\\Desktop\\PLOTS\\TEST\\PercEQ\\CORR_"*string(j)*string(i)*".png")
    end
end
