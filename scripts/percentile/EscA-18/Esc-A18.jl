...
savepath = datadir("results", "Percentile", "Esc-A18", "Optim")
savepath_best = datadir("results", "Percentile", "Esc-A18", "BestOptim")
savepath_plots = mkpath(plotsdir("Percentile", "Esc-A18"))
