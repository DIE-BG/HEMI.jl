...
plots_path = mkpath(plotsdir("mse-combination", "Esc-E-Scramble", "ls"))
...
# Máscara para seleccionar componentes principales a combinar
MAIN_COMPONENTS = [true for fn in cvconfig.inflfn.functions]
...
obsfn_C = InflationCombination(
    InflationEnsemble(InflationConstant(), testconfig.inflfn.functions[MAIN_COMPONENTS]...), 
    w_C, 
    "Óptima MSE C"
)
