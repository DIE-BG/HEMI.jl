...
plots_path = mkpath(plotsdir("mse-combination", "Esc-E2-NoMAI", "share"))
...
obsfn_share_D = InflationCombination(
    InflationConstant(), testconfig.inflfn.functions[components_mask]..., 
    w_D, 
...
components_mask = MAIN_COMPONENTS .& [!(fn isa InflationFixedExclusionCPI) for fn in cvconfig.inflfn.functions]
