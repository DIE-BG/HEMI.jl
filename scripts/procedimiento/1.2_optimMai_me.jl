...
savepath = datadir("results", "optim", "CoreMai", "Me")
savepath_best = datadir("results", "optim", "CoreMai", "Me","BestOptim")
...
for config in optconfig
    optimizemai(config, gtdata; K, savepath, maxiterations = MAXITER, metric = :me)
end 
