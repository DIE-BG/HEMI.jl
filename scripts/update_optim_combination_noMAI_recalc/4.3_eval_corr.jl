...
combination_loadpath  = datadir("results","optim_combination","corr_noMAI_recalc")

save_results = datadir("results","eval","corr_noMAI_recalc")
...
w_tray_mai     = sum(df_renorm_mai.w_tray, dims=1)[1] #./ mai_w  # comentamos para prevenir NaNs
w_tray_19_mai  = sum(df_renorm_19_mai.w_tray, dims=1)[1] #./ mai_w # comentamos para prevenir NaNs
...
# ├───────────────────────────────────────────────┼────────────┼──────────┼──────────┼──────────┼──────────┼───────────────┤
# │                 Percentil equiponderado 80.86 │   0.276791 │ 0.975113 │ 0.983872 │ 0.911682 │ 0.985763 │      0.992383 │
# │                      Percentil ponderado 81.0 │ 0.00783096 │ 0.938299 │ 0.980331 │ 0.791392 │ 0.975789 │      0.982125 │
# │     Media Truncada Equiponderada (55.0, 92.0) │   0.705083 │ 0.978721 │ 0.985344 │ 0.915579 │ 0.986772 │      0.993255 │
# │       Media Truncada Ponderada (53.56, 96.47) │ 0.00106925 │  0.94964 │ 0.982119 │ 0.781927 │ 0.979123 │       0.98387 │
# │  Inflación de exclusión dinámica (0.46, 4.97) │ 0.00915982 │ 0.946347 │ 0.978487 │ 0.762266 │ 0.978094 │      0.982066 │
# │ Exclusión fija de gastos básicos IPC (14, 51) │        0.0 │  0.94211 │ 0.973802 │ 0.643733 │ 0.979527 │       0.97927 │
# │                          MAI óptima CORR 2023 │        0.0 │      NaN │      NaN │      NaN │      NaN │           NaN │
# │                   Subyacente óptima CORR 2023 │        1.0 │ 0.978405 │ 0.985432 │ 0.916698 │ 0.986736 │      0.993231 │
# │                 MAI (FP,4,[0.26, 0.51, 0.75]) │        0.0 │ 0.975304 │ 0.988008 │ 0.900723 │  0.98262 │      0.988608 │
# │                   MAI (F,4,[0.25, 0.5, 0.74]) │        0.0 │  0.97512 │ 0.987969 │ 0.899583 │ 0.982588 │      0.988616 │
# │                   MAI (G,4,[0.26, 0.5, 0.75]) │        0.0 │ 0.940058 │ 0.984834 │ 0.767826 │ 0.970803 │      0.977716 │
# └───────────────────────────────────────────────┴────────────┴──────────┴──────────┴──────────┴──────────┴───────────────┘
