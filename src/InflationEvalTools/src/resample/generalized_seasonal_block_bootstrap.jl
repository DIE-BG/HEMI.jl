# generalized_seasonal_block_bootstrap.jl - Funciones para remuestrear objetos
...
Base.@kwdef struct GeneralizedSeasonalBlockBootstrap <: ResampleFunction
    blocklength::Int = 25
end
...
function (resample_gsbb_fn::ResampleGSBB)(cs::CountryStructure, rng = Random.GLOBAL_RNG)
